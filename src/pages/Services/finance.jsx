...
import WhoWeAre1 from "../../assets/financeService.svg";
...
const FinanceServices = () => {
  const heroContent = [
    {
      id: 1,
      text: " Offering financial advisory services to improve budgeting and forecasting.",
    },
    {
      id: 2,
      text: "Assisting startups and SMEs with capital allocation and resource optimisation.",
    },
    {
      id: 3,
      text: "Providing investment analysis and portfolio management guidance.",
    },
  ];
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-center md:justify-between bg-white p-4 md:p-10">
        ...
        >
          <div className="text-2xl md:text-4xl 2xl:text-5xl font-primaryBold text-[#565656] text-center md:text-left leading-10 md:leading-[50px] 2xl:leading-[60px]">
            Smart Financial Strategies to <br />
          ...
          <p className="md:w-[654px] text-[#455A64] md:text-xl font-primaryMedium text-justify leading-8 md:leading-10">
            Financial management is the backbone of business success. At Aleph
            Biz Solutions Ltd, we provide comprehensive financial services
            designed to stabilise operations, improve cash flow, and support
            growth. From budgeting to investment planning, our expertise helps
            businesses make sound financial decisions.
          </p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, x: 200 }}
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-10">
          ...
          >
            ...
            <h3 className="text-lg md:text-xl font-primaryBold text-[#455A64] mb-4 text-center">
              Credit Solutions and <br />
              Microlending
            </h3>
            <p className="text-[#455A64] text-justify text-sm md:text-xl font-primaryMedium leading-10 md:leading-10">
              We offer tailored credit and microlending services to startups and
              SMEs, ensuring access to working capital for immediate needs or
          ...
          >
            ...
            <h3 className="text-lg md:text-xl font-primaryBold text-[#455A64] mb-4 text-center">
              Trade and Debt Financing
            </h3>
            <p className="text-[#455A64] text-justify text-sm md:text-xl md:text-left font-primaryMedium leading-10 md:leading-10">
              Our trade finance solutions enable businesses to expand into new
              markets confidently, while debt financing options help manage
              long-term financial needs responsibly.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl md:text-left font-primaryMedium leading-10 md:leading-10">
              We provide in-depth guidance on portfolio management, resource
              optimisation, and strategic investments, ensuring businesses
              maximise returns while mitigating risks.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center gap-10 bg-white p-4 md:p-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-3 md:gap-6">
          <div className="grid gap-3">
            <div className="bg-[#34C759]/[15%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
              ...
              <p className="font-primaryRegular md:text-lg 2xl:text-xl">
                Access credit, improve cash flow, and stabilise operations for
                immediate impact.
              </p>
            </div>
            <div className="bg-[#34C759]/[15%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
              ...
              <p className="font-primaryRegular md:text-lg 2xl:text-xl">
                Expand confidently with financing solutions designed for
                long-term growth.
              </p>
            </div>
          </div>
          <div className="bg-[#FFC107]/[50%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
            ...
            <p className="font-primaryRegular md:text-lg 2xl:text-xl">
              Make informed decisions with expert advisory services tailored to
              your business goals.
            </p>
          </div>
        </div>
          ...
          <div className="w-auto flex items-center justify-between gap-6 md:gap-[100px]">
            <div className="grid gap-4">
              ...
              <p className="md:w-[628px] text-white text-xs md:text-2xl font-primaryMedium">
                Take control of your finances and position your business for
                success. Book an appointment today to thrive today and scale
                tomorrow.
              </p>
