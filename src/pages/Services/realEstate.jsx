...
import WhoWeAre1 from "../../assets/realEstate.svg";
...
const RealEstate = () => {
  const heroContent = [
    {
      id: 1,
      text: "Property management advisory for business expansions.",
    },
    {
      id: 2,
      text: "Leasing opportunities to help businesses establish a physical presence in key locations.",
    },
  ];
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-center md:justify-between bg-white p-4 md:p-10">
        ...
        >
          ...
          <p className="md:w-[654px] text-[#455A64] md:text-xl font-primaryMedium text-justify leading-8 md:leading-10">
            A physical presence can be a game-changer for businesses looking to
            establish credibility and expand operations. At Aleph Biz Solutions
            Ltd, we provide comprehensive real estate services designed to
            support business growth and operational success.
          </p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, x: 200 }}
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-10">
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl font-primaryMedium leading-10 md:leading-10">
              We help businesses identify and manage properties that align with
              their strategic goals, offering guidance on site selection, lease
              negotiation, and operational optimisation.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl md:text-left font-primaryMedium leading-10 md:leading-10">
              Whether you’re setting up a new office, retail outlet, or
              warehouse, our leasing solutions are tailored to meet your
              specific needs, ensuring seamless integration into key locations.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl md:text-left font-primaryMedium leading-10 md:leading-10">
              For businesses looking to scale, we provide advisory services that
              simplify the process of acquiring and managing additional
              properties, enabling smooth expansion into new markets.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center gap-10 bg-white p-4 md:p-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-3 md:gap-6">
          <div className="grid gap-3">
            <div className="bg-[#34C759]/[15%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
              ...
              <p className="font-primaryRegular md:text-lg 2xl:text-xl">
                Establish a strong physical presence to enhance credibility and
                visibility.
              </p>
            </div>
            <div className="bg-[#34C759]/[15%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
              ...
              <p className="font-primaryRegular md:text-lg 2xl:text-xl">
                Expand operations with strategic real estate solutions designed
                for growth.
              </p>
            </div>
          </div>
          <div className="bg-[#FFC107]/[50%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
            ...
            <p className="font-primaryRegular md:text-lg 2xl:text-xl">
              Optimise space utilisation for maximum productivity and impact.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="w-auto flex items-center justify-between gap-6 md:gap-[100px]">
            <div className="grid gap-4">
              ...
              <p className="md:w-[628px] text-white text-xs md:text-2xl font-primaryMedium">
                Secure the ideal location for your business. Book an appointment
