...
import WhoWeAre1 from "../../assets/researchMarket.svg";
...
const ResearchServices = () => {
  const heroContent = [
    {
      id: 1,
      text: "Conducting comprehensive market research to uncover growth opportunities.",
    },
    {
      id: 2,
      text: "Providing trend analysis and public opinion polling for strategic decision-making.",
    },
  ];
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-center md:justify-between bg-white p-4 md:p-10">
        ...
        >
          ...
          <p className="md:w-[654px] text-[#455A64] md:text-xl font-primaryMedium text-justify leading-8 md:leading-10">
            Informed decisions drive business success. At Aleph Biz Solutions
            Ltd, we provide comprehensive market research and insights to help
            businesses navigate dynamic markets and capitalise on emerging
            opportunities.
          </p>
        </motion.div>
        <motion.div
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-10">
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl font-primaryMedium leading-10 md:leading-10">
              Our research uncovers growth opportunities by analysing trends,
              market dynamics, and competitive landscapes, ensuring your
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl md:text-left font-primaryMedium leading-10 md:leading-10">
              Using advanced tools and methodologies, we provide deep insights
              into market trends and consumer behaviour, helping you adapt and
              respond proactively.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl md:text-left font-primaryMedium leading-10 md:leading-10">
              For businesses requiring stakeholder engagement or feedback, our
              polling services provide a clear understanding of public
              sentiment, enabling better decision-making.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center gap-10 bg-white p-4 md:p-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-3 md:gap-6">
          <div className="grid gap-3">
            <div className="bg-[#34C759]/[15%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
              ...
              <p className="font-primaryRegular md:text-lg 2xl:text-xl">
                 Make informed decisions with actionable, data-driven insights.
              </p>
            </div>
            <div className="bg-[#34C759]/[15%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
              <h3 className="font-primaryBold text-xl md:text-2xl 2xl:text-3xl my-4">
              ...
              <p className="font-primaryRegular md:text-lg 2xl:text-xl">
                Position your business to seize future opportunities
                confidently.
              </p>
            </div>
          </div>
          <div className="bg-[#FFC107]/[50%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
            ...
            <p className="font-primaryRegular md:text-lg 2xl:text-xl">
              Stay ahead of market trends and adapt strategies effectively.
            </p>
          </div>
        </div>
      </div>
