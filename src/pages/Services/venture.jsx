...
import WhoWeAre1 from "../../assets/ventureCapital.svg";
...
const VentureServices = () => {
  const heroContent = [
    {
      id: 1,
      text: "Providing funding for startups in need of capital for growth.",
    },
    {
      id: 2,
      text: "Equity partnerships to foster long-term relationships and shared success.",
    },
  ];
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-center md:justify-between bg-white p-4 md:p-10">
        ...
        >
          ...
          <p className="md:w-[654px] text-[#455A64] md:text-xl font-primaryMedium text-justify leading-8 md:leading-10">
            Access to capital is critical for businesses looking to expand and
            unlock their full potential. At Aleph Biz Solutions Ltd, we go
            beyond traditional funding, offering a holistic approach to
            financing that supports startups and SMEs at every stage of their
            growth journey.
          </p>
        </motion.div>
        <motion.div
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-10">
          ...
          >
            ...
            <h3 className="text-lg md:text-xl font-primaryBold text-[#455A64] mb-4 text-center">
              Startup Funding and <br />
              Equity Partnerships
            </h3>
            <p className="text-[#455A64] text-justify text-sm md:text-xl font-primaryMedium leading-10 md:leading-10">
              We provide startups with the capital they need to fuel innovation
              and scale operations. Through equity partnerships, we align our
              success with yours, fostering long-term collaboration and mutual
              growth.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl md:text-left font-primaryMedium leading-10 md:leading-10">
              Our team of experts offers guidance on capital allocation,
              resource optimisation, and portfolio management, ensuring
              businesses maximise their returns while mitigating risks.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#455A64] text-justify text-sm md:text-xl md:text-left font-primaryMedium leading-10 md:leading-10">
              Our credit, microlending, trade, and debt financing services offer
              businesses quick access to cash flow and the stability needed to
              expand into new markets and sustain long-term growth.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center gap-10 bg-white p-4 md:p-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-3 md:gap-6">
          <div className="grid gap-3">
            <div className="bg-[#34C759]/[15%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
              ...
              <p className="font-primaryRegular md:text-lg 2xl:text-xl">
                Overcome financial challenges with tailored funding solutions.
              </p>
            </div>
            <div className="bg-[#34C759]/[15%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
              <h3 className="font-primaryBold text-xl md:text-2xl 2xl:text-3xl my-4">
              ...
              <p className="font-primaryRegular md:text-lg 2xl:text-xl">
                Secure the capital needed to expand operations and seize new
                opportunities.
              </p>
            </div>
          </div>
          <div className="bg-[#FFC107]/[50%] w-[360px] md:w-[430px] rounded-[24px] p-4 md:p-8 text-[#455A64]">
            ...
            <p className="font-primaryRegular md:text-lg 2xl:text-xl">
              Build a sustainable financial model with expert guidance and
          ...
          <div className="w-auto flex items-center justify-between gap-6 md:gap-[100px]">
            <div className="grid gap-4">
              ...
              <p className="md:w-[628px] text-white text-xs md:text-2xl font-primaryMedium">
                Let us provide the funding you need to drive your business
                forward. Book an appointment today to thrive today and scale
                tomorrow.
              </p>
